...
export const MOCK_HISTORICAL_DRAWS: HistoricalDraw[] = [
  { id: '1', date: new Date('2024-05-01'), winning_number: 42, predicted_number: 42, is_hit: true },
  { id: '2', date: new Date('2024-05-02'), winning_number: 17, predicted_number: 89, is_hit: false },
  { id: '3', date: new Date('2024-05-03'), winning_number: 23, predicted_number: 23, is_hit: true },
  { id: '4', date: new Date('2024-05-04'), winning_number: 88, predicted_number: 12, is_hit: false },
  { id: '5', date: new Date('2024-05-05'), winning_number: 10, predicted_number: 10, is_hit: true },
  { id: '6', date: new Date('2024-04-30'), winning_number: 55, predicted_number: 50, is_hit: false },
  { id: '7', date: new Date('2024-04-29'), winning_number: 22, predicted_number: 22, is_hit: true },
...
export const MOCK_DAILY_PREDICTIONS: DailyPrediction[] = [
  {
    id: 'p1',
    target_date: new Date('2024-05-04'),
    top_prediction: 42,
...
export const MOCK_MONTHLY_METRICS: MonthlyMetric[] = [
  { id: 'm1', month_year: '2024-01', accuracy_rate: 0.65, average_log_loss: 0.55 },
  { id: 'm2', month_year: '2024-02', accuracy_rate: 0.68, average_log_loss: 0.52 },
  { id: 'm3', month_year: '2024-03', accuracy_rate: 0.72, average_log_loss: 0.48 },
  { id: 'm4', month_year: '2024-04', accuracy_rate: 0.75, average_log_loss: 0.45 },
  { id: 'm5', month_year: '2024-05', accuracy_rate: 0.78, average_log_loss: 0.42 },
];
