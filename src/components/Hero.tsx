...
// 1. Updated interface with all 4 runner-ups
...
export default function Hero({ prediction }: HeroProps) {
  ...
  // 2. THIS IS THE FIX: Gather all 4 runner-ups cleanly INSIDE the component
      ...
      >
        ...
        <div className="mt-6 pt-6 border-t border-gray-700">
          <p className="text-[10px] uppercase tracking-tighter text-gray-500 font-mono italic">
            * Predictions generated via XGBOOST & MONTE CARLO SIMULATION
          </p>
        </div>
      </motion.div>
    </section>
